...
const vendorTeam: VendorTeamMember[] = [
  {
    id: 'v1',
    name: 'Store owner',
...
export default function VendorUserManagementPage() {
  ...
  const filteredTeam = useMemo(() => {
    ...
    if (!q) return vendorTeam;
    return vendorTeam.filter(
      (m) =>
        ...
        <div className="p-4 sm:p-6">
            <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <h1 className="text-lg font-semibold text-slate-900">Manage corporate users</h1>
                  <p className="text-sm text-slate-500">
                    Companies you work with and the people who can message, approve, and order.
                  </p>
                </div>
                <button
                  type="button"
