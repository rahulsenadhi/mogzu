...
/**
 * Vendor post-registration welcome — layout copied from WelcomeScreen.tsx;
 * navigates to /vendor/dashboard (Step 12: welcome step missing from vendor flow).
 */
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FA8D40] via-[#FA8D40] to-[#e67c2d] flex flex-col items-center justify-center px-4">
      <div className="bg-white rounded-[24px] shadow-2xl p-8 sm:p-12 md:p-16 max-w-[600px] w-full text-center">
          ...
          <div className="relative">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#FA8D40] to-[#e67c2d] flex items-center justify-center shadow-lg">
              <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                className="animate-[vendor-welcome-scale-in_0.5s_ease-out]"
              >
                <path
                  d="M5 13l4 4L19 7"
                  stroke="white"
        ...
        <h1 className="text-[28px] sm:text-[36px] font-bold text-[#0e1e3f] mb-4">
          Welcome to Mogzu, partner! 🎉
        </h1>
        <p className="text-[16px] sm:text-[18px] text-[#475569] mb-8 leading-relaxed">
          Your partner account is ready. We&apos;re opening your vendor dashboard...
        </p>
        ...
        >
          {isContinuing ? 'Opening dashboard...' : 'Continue to vendor dashboard'}
        </button>
      </div>
      ...
      <style>{`
        @keyframes vendor-welcome-scale-in {
          0% {
            transform: scale(0);
          }
          50% {
