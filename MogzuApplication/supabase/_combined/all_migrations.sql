...
-- Idempotent across runs only where individual migrations are; if the project already has partial state, re-run will error on duplicate CREATE TABLE / POLICY.
