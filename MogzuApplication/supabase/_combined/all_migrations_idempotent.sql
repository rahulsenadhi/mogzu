...
-- Auto-generated by scripts/make-idempotent-combined.mjs at 2026-05-18T13:21:46.790Z.
...
DO $idem$ BEGIN
  EXECUTE 'CREATE TYPE public.notification_type AS ENUM (
  ''booking_confirmed'',
  ''booking_cancelled'',
  ''approval_required'',
  ''approval_decided'',
...
DO $idem$ BEGIN
  EXECUTE 'CREATE TYPE public.ticket_status AS ENUM (
...
DO $idem$ BEGIN
  EXECUTE 'CREATE TYPE public.ticket_priority AS ENUM (''low'', ''normal'', ''high'', ''urgent'');';
EXCEPTION WHEN duplicate_object THEN NULL;
END $idem$;

DO $idem$ BEGIN
  EXECUTE 'CREATE TYPE public.ticket_audience AS ENUM (''corporate'', ''vendor'');';
EXCEPTION WHEN duplicate_object THEN NULL;
END $idem$;
...
DO $idem$ BEGIN
  EXECUTE 'CREATE TYPE public.celebration_status AS ENUM (
...
DO $idem$ BEGIN
  EXECUTE 'CREATE TYPE public.dispute_status AS ENUM (
...
DO $idem$ BEGIN
  EXECUTE 'CREATE TYPE public.dispute_resolution AS ENUM (
...
DO $idem$ BEGIN
  EXECUTE 'CREATE TYPE public.review_status AS ENUM (
...
DO $idem$ BEGIN
  EXECUTE 'CREATE TYPE public.review_source AS ENUM (''booking'', ''invite'');';
EXCEPTION WHEN duplicate_object THEN NULL;
END $idem$;
...
DO $idem$ BEGIN
  EXECUTE 'CREATE TYPE public.promotion_kind AS ENUM (''percent_off'', ''flat_off'', ''free_addon'', ''paid_boost'');';
EXCEPTION WHEN duplicate_object THEN NULL;
END $idem$;
DO $idem$ BEGIN
  EXECUTE 'CREATE TYPE public.promotion_status AS ENUM (
...
DROP TRIGGER IF EXISTS trg_sso_config_updated_at ON public.sso_config;
...
DROP TRIGGER IF EXISTS trg_public_leads_updated_at ON public.public_leads;
...
DROP TRIGGER IF EXISTS trg_invoice_runs_updated_at ON public.invoice_runs;
...
DROP TRIGGER IF EXISTS trg_vendor_payout_methods_updated_at ON public.vendor_payout_methods;
...
DROP TRIGGER IF EXISTS trg_vendor_onboarding_applications_updated_at ON public.vendor_onboarding_applications;
...
DROP TRIGGER IF EXISTS trg_white_label_partners_updated_at ON public.white_label_partners;
...
DROP TRIGGER IF EXISTS trg_access_reviews_updated_at ON public.access_reviews;
...
DROP TRIGGER IF EXISTS trg_security_questionnaires_updated_at ON public.security_questionnaires;
